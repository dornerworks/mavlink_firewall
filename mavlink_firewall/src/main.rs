...
fn main() {
    ...
    let can_send = firewall(&packet);
    println!("packet {packet:?}\ncan_send: {can_send}");
    println!("Should be Well-Formed, can send\n");

    let packet = [
        0xfdu8, 0x20, 0x0, 0x0, 0xe, 0xff, 0xbe, 0x4c, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
        0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80, 0x7, 0x8e, 0x48, 0x0, 0x0, 0x0, 0x0,
        0x0, 0x0, 0x0, 0x0, 0x9a, 0xa6, 0x0, 0x1, 0x6b, 0x8b,
    ];

    let can_send = firewall(&packet);
    println!("packet {packet:?}\ncan_send: {can_send}");
    println!("Should be Well-Formed, cannot send\n");

    let packet = [
        0xfdu8, 0x21, 0x0, 0x0, 0xe, 0xff, 0xbe, 0x4c, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
        0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80, 0x7, 0x8e, 0x48, 0x0, 0x0, 0x0, 0x0,
        0x0, 0x0, 0x0, 0x0, 0x9a, 0xa6, 0x0, 0x1, 0x2, 0x6b, 0x8b,
    ];
